...
namespace WebApplication3.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult Login(Users u)
        
           {
            ...
            if (t != null)
            {
                ...
                return t.Rid switch
                {
                    6 => RedirectToAction("AdminDashboard"),
                    9 => RedirectToAction("ResidentDashboard"),
                    7 => RedirectToAction("SecretaryDashboard"),
        ...
        {                       
            ...
            var resident = _context.Users.Where(u => u.Rid == 9).ToList().Count();
            ViewData["resident"] = resident;
            var Secretary = _context.Users.Where(u => u.Rid == 7).ToList().Count();
            ViewData["Secretary"] = Secretary;
            var Security = _context.Users.Where(u => u.Rid == 8).ToList().Count();
        ...
        public ActionResult ResidentDashboard()
        {
            ...
            ViewData["maintenance"] = _context.Income.Where(m => m.Uid == userId).Count();
        ...
        public ActionResult SecurityDashboard()
        {
            ...
            var Gatepass = _context.Gatepass.ToList().Count();
            ViewData["Gatepass"] = Gatepass;

            var service = _context.Service.ToList().Count();
            ViewData["service"] = service;

            var visitor = _context.Visitor.ToList().Count();
   ...
   .ToList());
    ...
    .ToList());
        ...
        public ActionResult IncomeView()
        {
            ...
            using (var db = new visamodbContext())
            {
                var incomeData = db.Income
                    .Where(i =>
                        (i.Description != null && i.Description.ToLower().Contains("maintenance") && i.Status != null && i.Status.ToLower() == "paid")
                        || (i.Description != null && !i.Description.ToLower().Contains("maintenance"))
                    )
