...
namespace WebApplication3.Controllers
{
    public class ResidentController : Controller
    {
        ...
        public ActionResult GatepassCreate(Gatepass g)
        {
            try
            {
                ...
                GenerateQrCode(g.Visitorname + " " + g.Npeople + " " + g.Date + " " + g.Type + " " + g.Flatno + " " + g.Wingno, imagePath);
        ...
        public ActionResult GatepassEdit(Gatepass g, Users u)
        {
            try
            {
                Users uu = _context.Users.Where(u => u.Rid == 9).ToList().First();
                g.Uid = uu.Uid;
                g.Flatno=uu.Flatno;
                g.Wingno=uu.Wingno;
    ...
    .ToList();
        ...
        public ActionResult PayView(int Id)
        {
            ...
            string key = "rzp_test_8ySjk1vDKo6mq7";
            string secret = "MrE1IFnWodLm9bxICUrEeJmH";
        ...
        {            
            ...
            try
            {
                ...
                RazorpayClient client = new RazorpayClient("rzp_test_8ySjk1vDKo6mq7", "MrE1IFnWodLm9bxICUrEeJmH");
        ...
        public ActionResult ViewMaintenance()
        {
            ...
            using (var db = new visamodbContext()) // Ensure this is your actual DbContext
            {
                ...
                var maintenanceData = db.Income
                        .Where(i => i.Wingno == wingno && i.Flatno == flatno)
    ...
    .ToList();
        ...
        public ActionResult Eventname(Event e)
        {
            try
            {
                ...
                if (e.Bookdate.Date < DateTime.Today)
                {
        ...
        {
            var eventJson = TempData["EventData"] as string;
            if (eventJson == null)
                return RedirectToAction("Eventname");

            Event e = JsonConvert.DeserializeObject<Event>(eventJson);
